...
class GetStudentActivityCommand {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!((yield this.backendCommandReceiver.getActivityDetails(this.activityID)) === null)) {
                //Testa se Estudante existe
                if (!((yield this.backendCommandReceiver.getStudentAnalytics({ "activityID": this.activityID, "InveniRAstdID": this.InveniRAstdID })) === null)) {
